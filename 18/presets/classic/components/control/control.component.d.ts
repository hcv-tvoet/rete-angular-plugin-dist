...
export declare class ControlComponent<T extends 'text' | 'number'> implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ControlComponent<any>, "ng-component", never, { "data": { "alias": "data"; "required": false; }; "rendered": { "alias": "rendered"; "required": false; }; }, {}, never, never, false, never>;
}
