...
export declare class NodeComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NodeComponent, "ng-component", never, { "data": { "alias": "data"; "required": false; }; "emit": { "alias": "emit"; "required": false; }; "rendered": { "alias": "rendered"; "required": false; }; "seed": { "alias": "seed"; "required": false; }; }, {}, never, never, true, never>;
}
export {};
